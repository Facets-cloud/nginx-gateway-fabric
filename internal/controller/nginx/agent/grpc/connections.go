...
type Connection struct {
	...
	// Generation, set by Track, guards RemoveConnection against deleting a re-tracked entry (#5330).
	Generation int
}
...
// RemoveConnection deletes the entry only if its generation matches (compare-and-delete, #5330).
